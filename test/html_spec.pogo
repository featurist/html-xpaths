...
describe 'html'
  ...
  get(text) =
    expression = dsl.(subject).call(dsl, text)
  ...
  describe ".definitionDescription()"
    ...
    it("finds definition description by id")
      get('latte').should.equal "with-id"

    it("finds definition description by term")
      get("Milk").should.equal "with-dt"
